        ...
        <form action="{{ route('listings.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
           ...
           {{-- Type Selection --}}
            ...
            <div class="flex flex-col gap-3 border-t border-gray-800 pt-4 sm:flex-row sm:items-center sm:justify-end">
                ...
                <button type="submit" class="w-full px-6 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-gray-950 font-semibold text-sm transition sm:w-auto">Publish Listing</button>
            </div>
        </form>
    </div>
</div>
